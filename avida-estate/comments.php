...
<div class="mt-100">
    <div class="pxp-blog-comments-block">
        <div id="comments" class="comments-area pxp-blog-post-comments">
            ...
            if ($post_type == 'agent' || $post_type == 'property') {
                ...
                if ($post_type == 'property') $comment_field = esc_html__('Your review helps renters choose the right home. Tell others about your experience with this rental.', 'resideo');
