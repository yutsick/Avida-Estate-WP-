...
$blog_page_title             = isset($resideo_appearance_settings['resideo_blog_title_field']) ? $resideo_appearance_settings['resideo_blog_title_field'] : '';
$blog_page_subtitle          = isset($resideo_appearance_settings['resideo_blog_subtitle_field']) ? $resideo_appearance_settings['resideo_blog_subtitle_field'] : '';
        ...
        <div class="container">
            <h1 class="pxp-page-header">
                <?php if ($blog_page_title != '') {
                    ...
                    esc_html_e('Latest Articles', 'resideo');
                } ?>
            </h1>

            <?php if ($blog_page_subtitle != '') { ?>
                <p class="pxp-text-light"><?php echo esc_html($blog_page_subtitle); ?></p>
            <?php } 

            get_template_part('templates/featured_posts_carousel'); 
            ...
            <div class="row mt-200 pxp-posts-lists">
