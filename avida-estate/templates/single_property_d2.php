...
while (have_posts()) : the_post();
    ...
    <div class="pxp-content">
        ...
        <div class="container mt-4 mt-md-5">
            <div class="row">
                <?php $right_side_class = 'col-12';
                if ($photos[0] != '') { 
                    $right_side_class = 'col-lg-4'; ?>
                    <div class="col-lg-8">
                            ...
                            <div class="pxp-single-property-gallery-d2-thumbs-container">
                                <div class="owl-carousel pxp-single-property-gallery-d2-thumbs">
                                    <?php for ($j = 0; $j < count($photos); $j++) {
                                        ...
                                        <div>
                                            <div class="pxp-single-property-gallery-d2-thumbs-item pxp-cover rounded-lg <?php echo esc_attr($active_thmb_class); ?>" style="background-image: url(<?php echo esc_url($p_photo_thmb[0]); ?>);"></div>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <?php } ?>
                <div class="<?php echo esc_attr($right_side_class); ?>">
