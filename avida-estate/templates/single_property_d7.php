    ...
    <div class="pxp-content">
        ...
        if ($photos[0] != '') { ?>
            <div class="pxp-single-property-gallery-container <?php echo esc_attr($gallery_class); ?>">
                <div id="pxp-single-property-gallery-d7" class="pxp-single-property-gallery-d7 carousel slide" data-ride="carousel" data-interval="false">
                    <ol class="carousel-indicators">
                        <?php for ($i = 0; $i < count($photos); $i++) {
                            $active_indicator_class = $i == 0 ? 'active' : ''; ?>
                                <li data-target="#pxp-single-property-gallery-d7" data-slide-to="<?php echo esc_attr($i); ?>" class="<?php echo esc_attr($active_indicator_class); ?>"></li>
                        <?php } ?>
                    </ol>
                    <div class="carousel-inner pxp-single-property-gallery-d7-inner" role="listbox" itemscope itemtype="http://schema.org/ImageGallery">
                        <?php for ($i = 0; $i < count($photos); $i++) {
                    ...
                    <a class="pxp-carousel-control-prev pxp-animate" href="#pxp-single-property-gallery-d7" data-slide="prev">
                        <?php if (is_rtl()) { ?>
                    ...
                    <a class="pxp-carousel-control-next pxp-animate" href="#pxp-single-property-gallery-d7" data-slide="next">
                        <?php if (is_rtl()) { ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32.414" height="20.828" viewBox="0 0 32.414 20.828">
                                <g id="Group_30" data-name="Group 30" transform="translate(-1845.086 -1586.086)">
                                    <line id="Line_2" data-name="Line 2" x1="30" transform="translate(1846.5 1596.5)" fill="none" stroke="#333" stroke-linecap="round" stroke-width="2"/>
